<template>
  ...
  >
    ...
    <button v-if="props.isSortable" type="button" :class="[
      ...
      <Icon v-if="props.sortDirection === 'asc'" name="uil:arrow-up" class="inline-block text-gray-900 dark:text-gray-100 text-lg" size="1em" />
      <Icon v-else-if="props.sortDirection === 'desc'" name="uil:arrow-down" class="inline-block text-gray-900 dark:text-gray-100 text-lg" size="1em" />
